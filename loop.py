...
def loop():
    ...
    try:
        ...
        gain_motor_angle                   = 0.1606 * 3 * 0.80    # K_F[0]
        gain_gyro_angle                    = 30.2153 * 2.5 * 0.80 # K_F[1]
        gain_motor_angular_speed           = 1.0796 * 1.7 * 0.80  # K_F[2]
        gain_gyro_rate                     = 3.3269 * 2 * 0.80    # K_F[3]
        gain_motor_angle_error_accumulated = 0.4472 * 0.80        # K_I
        ...
        # ここでライントレースする
        speed, steering = line_tracer.line_tracing()
        ...
        while True:
            ...
            gain_angle_speed = 7.5
            motor_angular_speed_reference = ((1.0 - a_r) * ((speed / 100.0) * gain_angle_speed)) + (a_r * motor_angular_speed_reference)
